...
def get_machine_id() -> t.Optional[t.Union[str, bytes]]:
    ...
    def _generate() -> t.Optional[t.Union[str, bytes]]:
        ...
        for filename in "/etc/this-will-not-exist", "./boot_id":
            try:
...
def get_pin_and_cookie_name(
    ...
    probably_public_bits = [
        "root",# username, # root or None
        modname, #flask.app
        # mac = 02:42:ac:18:00:03
        # getattr(app, "__name__", type(app).__name__),
        "Flask" ##or maybe WSGIApplication
    ...
    private_bits = [str(2485378351107), get_machine_id()]
    h = hashlib.sha1()
...
print(get_pin_and_cookie_name(app="WSGIApplication"))
